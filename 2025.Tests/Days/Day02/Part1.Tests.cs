...
public class Part1Tests
{
    ...
    public void Part1_WithExampleInput_ReturnsExpectedResult()
    {
        ...
        // Act
        var result = Part1.Solution(input);
    ...
    {
        Assert.True(Part1.IsInvalidNumber(55));
    }

    [Fact]
    public void IsInvalidNumber_6464_ReturnsTrue()
    {
        Assert.True(Part1.IsInvalidNumber(6464));
    }

    [Fact]
    public void IsInvalidNumber_123123_ReturnsTrue()
    {
        Assert.True(Part1.IsInvalidNumber(123123));
    }

    [Fact]
    public void IsInvalidNumber_101_ReturnsFalse()
    {
        Assert.False(Part1.IsInvalidNumber(101));
    }

    [Fact]
    public void IsInvalidNumber_1234_ReturnsFalse()
    {
        Assert.False(Part1.IsInvalidNumber(1234));
    }

    [Fact]
    public void IsInvalidNumber_11_ReturnsTrue()
    {
        Assert.True(Part1.IsInvalidNumber(11));
    }

    [Fact]
    public void ConstructInvalidNumber_5_Returns55()
    {
        Assert.Equal(55, Part1.ConstructInvalidNumber(5));
    }

    [Fact]
    public void ConstructInvalidNumber_64_Returns6464()
    {
        Assert.Equal(6464, Part1.ConstructInvalidNumber(64));
    }

    [Fact]
    public void ConstructInvalidNumber_123_Returns123123()
    {
        Assert.Equal(123123, Part1.ConstructInvalidNumber(123));
    }

    [Fact]
    public void ConstructInvalidNumber_11885_Returns1188511885()
    {
        Assert.Equal(1188511885, Part1.ConstructInvalidNumber(11885));
    }

    [Fact]
    public void GetFirstHalf_1010_2_Returns10()
    {
        Assert.Equal(10, Part1.GetFirstHalf(1010, 2));
    }

    [Fact]
    public void GetFirstHalf_123123_3_Returns123()
    {
        Assert.Equal(123, Part1.GetFirstHalf(123123, 3));
    }

    [Fact]
    public void GetFirstHalf_1188511885_5_Returns11885()
    {
        Assert.Equal(11885, Part1.GetFirstHalf(1188511885, 5));
    }

    [Fact]
    public void GetFirstHalf_99_1_Returns9()
    {
        Assert.Equal(9, Part1.GetFirstHalf(99, 1));
    }

    [Fact]
    public void SplitIntoEvenLengthRanges_99_1050_Returns()
    {
        Assert.Equal([(99,99), (1000, 1050)], Part1.SplitIntoEvenLengthRanges(99, 1050));
    }

    [Fact]
    public void SplitIntoEvenLengthRanges_100_999_Returns()
    {
        Assert.Equal([], Part1.SplitIntoEvenLengthRanges(100, 999));
    }

    [Fact]
    public void SplitIntoEvenLengthRanges_1010_2020_Returns()
    {
        Assert.Equal([(1010, 2020)], Part1.SplitIntoEvenLengthRanges(1010, 2020));
    }

    [Fact]
    public void SplitIntoEvenLengthRanges_1050_99_Returns()
    {
        Assert.Equal([], Part1.SplitIntoEvenLengthRanges(1050, 99));
    }

    [Fact]
    public void SumInvalidIdsInRange_11_22_Returns33()
    {
        Assert.Equal(33, Part1.SumInvalidIDsInRange(11, 22));
    }

    [Fact]
    public void SumInvalidIdsInRange_95_115_Returns99()
    {
        Assert.Equal(99, Part1.SumInvalidIDsInRange(95, 115));
    }

    [Fact]
    public void SumInvalidIdsInRange_998_1012_Returns1010()
    {
        Assert.Equal(1010, Part1.SumInvalidIDsInRange(998, 1012));
    }
}
